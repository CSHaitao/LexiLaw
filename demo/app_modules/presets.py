...
small_and_beautiful_theme = gr.themes.Soft(
        primary_hue=gr.themes.Color(
            c50="#1E90FF",
            c100="rgba(30,144,255, 0.2)",
            c200="#1E90FF",
            c300="rgba(186,85,211, 0.32)",
            c400="rgba(105,105,105, 0.32)",
            c500="rgba(30,144,255, 1.0)",
            c600="rgba(30,144,255, 1.0)",
            c700="rgba(30,144,255, 0.32)",
            c800="rgba(30,144,255,  0.32)",
            c900="#1E90FF",
            c950="#1E90FF",
        ),
        ...
        button_primary_border_color="#00008B",
        button_primary_border_color_dark="#00008B",
        button_primary_text_color="#1E90FF",
